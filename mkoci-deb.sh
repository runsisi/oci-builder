...
export IMAGE=${IMAGE:=kylin-desktop}
export TAG=${TAG:=v10-$(date +%Y%m%d)}
export MIRROR=${MIRROR:=http://archive.kylinos.cn/kylin/KYLIN-ALL}
export SUITE=${SUITE:=10.1-2303-updates}
export EXTRA_SUITES=${EXTRA_SUITES:=10.1}
